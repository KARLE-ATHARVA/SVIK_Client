...
$(function(){
    ...
    function getQrGenerateBase() {
        ...
        if (!base) base = "https://vyr.svikinfotech.in/api";
        if (/localhost|127\.0\.0\.1/i.test(base)) base = "https://vyr.svikinfotech.in/api";
    ...
    function fetchGeneratedProductUrl(tile, done) {
        ...
        var candidates = [
            ...
            "https://vyr.svikinfotech.in/api/Generate?" + query,
            "https://vyr.svikinfotech.in/api/ProductQr/Generate?" + query
        ];
    ...
    function fetchQrDataUrl(link, done) {
        ...
        function tryProvider(index) {
            ...
            var direct = providers[index];
            loadImageForPdf(direct, function(qrImgData) {
...
function getDirectUserActivityUrl() {
    ...
    var base = String(baseFromStorage || "https://vyr.svikinfotech.in/api/").trim();
    if (!base) base = "https://vyr.svikinfotech.in/api/";
    if (/localhost|127\.0\.0\.1/i.test(base)) base = "https://vyr.svikinfotech.in/api/";
