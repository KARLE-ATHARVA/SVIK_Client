...
(function(e) {
        ...
        e.ui.position = {
            ...
            flip: {
                ...
                top: function(e, t) {
                    ...
                    (0 > s || o(u) > s) && (e.top += p + f + m)) : d > 0 && (i = e.top - t.collisionPosition.marginTop + p + f + m - h,
    ...
    e.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function(t, i, s) {
            e.each(s.sortables, function() {
                ...
                n._intersectsWith(n.containerCache) && (a = !0,
                e.each(s.sortables, function() {
    ...
    e.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(t, i, s) {
            var a = s.options
              ...
              , o = s.document[0];
            r !== o && "HTML" !== r.tagName ? (a.axis && "x" === a.axis || (s.overflowOffset.top + r.offsetHeight - t.pageY < a.scrollSensitivity ? r.scrollTop = n = r.scrollTop + a.scrollSpeed : t.pageY - s.overflowOffset.top < a.scrollSensitivity && (r.scrollTop = n = r.scrollTop - a.scrollSpeed)),
            a.axis && "y" === a.axis || (s.overflowOffset.left + r.offsetWidth - t.pageX < a.scrollSensitivity ? r.scrollLeft = n = r.scrollLeft + a.scrollSpeed : t.pageX - s.overflowOffset.left < a.scrollSensitivity && (r.scrollLeft = n = r.scrollLeft - a.scrollSpeed))) : (a.axis && "x" === a.axis || (t.pageY - e(o).scrollTop() < a.scrollSensitivity ? n = e(o).scrollTop(e(o).scrollTop() - a.scrollSpeed) : e(window).height() - (t.pageY - e(o).scrollTop()) < a.scrollSensitivity && (n = e(o).scrollTop(e(o).scrollTop() + a.scrollSpeed))),
    ...
    e.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(t) {
            ...
            a && n ? (r.offset.left = r.parentData.left + r.position.left,
    ...
    e.ui.plugin.add("resizable", "grid", {
        resize: function() {
            ...
            m && (p -= l),
            g && (f -= u),
            /^(se|s|e)$/.test(o) ? (i.size.width = p,
            i.size.height = f) : /^(ne)$/.test(o) ? (i.size.width = p,
            i.size.height = f,
            i.position.top = r.top - c) : /^(sw)$/.test(o) ? (i.size.width = p,
            i.size.height = f,
            i.position.left = r.left - d) : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)),
            f - u > 0 ? (i.size.height = f,
            i.position.top = r.top - c) : (f = u - t.height,
            i.size.height = f,
            i.position.top = r.top + n.height - f),
            p - l > 0 ? (i.size.width = p,
            i.position.left = r.left - d) : (p = l - t.width,
            i.size.width = p,
    ...
    e.widget("ui.accordion", {
        ...
        _animate: function(e, t, i) {
            ...
            e.hide().animate(this.showProps, {
                ...
                step: function(e, i) {
                    i.now = Math.round(e),
                    "height" !== i.prop ? "content-box" === h && (o += i.now) : "content" !== r.options.heightStyle && (i.now = Math.round(s - t.outerHeight() - o),
                    o = 0)
                }
            }),
    ...
    e.widget("ui.menu", {
        ...
        _keydown: function(t) {
            ...
            default:
                ...
                i.length || (a = String.fromCharCode(t.keyCode),
                i = this._filterMenuItems(a)),
    ...
    e.widget("ui.tooltip", {
        ...
        _updateContent: function(e, t) {
            ...
            return "string" == typeof s ? this._open(t, e, s) : (i = s.call(e[0], function(i) {
                a._delay(function() {
                    e.data("ui-tooltip-open") && (t && (t.type = n),
                    this._open(t, e, i))
                })
            }),
            i && this._open(t, e, i),
        ...
        _open: function(t, i, s) {
            ...
            if (s) {
                if (n = this._find(i))
                    return n.tooltip.find(".ui-tooltip-content").html(s),
                    void 0;
        ...
        close: function(t) {
            ...
            void 0) : (a.removeData("ui-tooltip-open"),
            void 0)
        },
        _tooltip: function(t) {
